	...
	if (!empty($_POST['id_usuario']) 		&&
		...
		if (UsuarioVerificado($id_usuario, $online_hash)) {
            ...
            if (is_array($result)){
                ...
                DBExecute("UPDATE tb_suspeitos SET nome_alcunha = '$nome_alcunha', nome_alcunha_soundex = '$nome_alcunha_soundex' WHERE id_suspeito = {$id_suspeito} LIMIT 1");

                Sucesso('Nome/alcunha editado com sucesso.');
            }
            else {
