	...
	if (!empty($_POST['id_usuario']) 		&&
		...
		if (UsuarioVerificado($id_usuario, $online_hash)) {
            ...
            if (is_array($result)){
                ...
                DBExecute("UPDATE tb_suspeitos SET nome_completo = '$nome_completo', nome_completo_soundex = '$nome_completo_soundex' WHERE id_suspeito = {$id_suspeito} LIMIT 1");

                Sucesso('Nome completo editado com sucesso.');
            }
            else {
